...
@Component({
  selector: 'app-analysis-tutorial-modal',
  styleUrl: './analysis-tutorial-modal.component.scss',
  templateUrl: './analysis-tutorial-modal.component.html',
  imports: [
    ItModalComponent,
    ItButtonDirective
  ]
})
export class AnalysisTutorialModalComponent {
